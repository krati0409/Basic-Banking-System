       ...
       <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link parent-link" href="http://localhost/Apps/index.php">Customers</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link parent-link" href="http://localhost/Apps/Transfer_Money.php">Transfer Money</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link parent-link" href="http://localhost/Apps/transactionHistory.php">Transaction History</a> 
              </li>
            </ul>
        </div>
    </nav>
